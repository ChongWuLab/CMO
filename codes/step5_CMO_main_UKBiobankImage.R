...
# set working dir
dat.dir <- "/gpfs/research/chongwu/Chong/UKBiobankImage/"
...
varint.inf = readRDS(paste(dat.dir, "variants_inf.rds", sep = ""))
...
sumstat.orgin = cbind(varint.inf,sumstat.orgin)
sumstat.orgin = sumstat.orgin[!is.na(sumstat.orgin[,5]),]

sumstat.orgin = sumstat.orgin[,c(5,3,4,6,1)]
colnames(sumstat.orgin) = c("SNP","A1","A2","Z","CHR")
rm(varint.inf)
