...
out.fun <- function(pheno.input) {
  setwd(paste("/gpfs/research/chongwu/Chong/MWAS/res/res3_", pheno.input, sep = ""))
  ...
  out.file = paste("/gpfs/research/chongwu/Chong/MWAS/resAna/res3_cross_CpG_", pheno.input, ".rds", sep = "")
  saveRDS(res, out.file)

  out.file = paste("/gpfs/research/chongwu/Chong/MWAS/resAna/res3_signle_CpG_", pheno.input, ".rds", sep = "")
...
for(i in 166:179) {
    out.fun(paste("Z_0",i,sep=""))
}

for(i in 2649:2655) {
    out.fun(paste("Z_",i,sep=""))
}
